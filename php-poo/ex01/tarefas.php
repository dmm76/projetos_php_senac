        ...
        <div class="card mt-3 mb-2">
            <div class="card-body">
                <table class="table table-bordered">
                    ...
                    <?php
                    $sql = "SELECT * FROM tarefa inner join usuario on tarefa.idUsuario=usuario.idUsuario ORDER BY tarefa.idTarefa ASC";
                    $resultado = mysqli_query($conexao, $sql);
                    ...
                    while ($row = mysqli_fetch_assoc($resultado)) {
                        ...
                        <tr>
                            ...
                            <td>" . $row['nome'] . "</td>
                             <td>
                                <a href='tarefa.php?idTarefa=" . $row['idTarefa'] . "' class='btn btn-primary btn-sm'>Editar</a>
