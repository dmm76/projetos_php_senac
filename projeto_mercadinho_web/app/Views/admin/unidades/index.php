      ...
      <div class="row g-3">
        ...
        <div class="col-12 col-lg-9">
          <div class="d-flex align-items-center justify-content-between mb-3">
            <h1 class="h4 mb-0">Unidades</h1>
            <a class="btn btn-danger" href="<?= \App\Core\Url::to('/admin/unidades/criar') ?>">
          ...
          <div class="table-responsive shadow-sm">
            <table class="table table-striped align-middle mb-0">
              <thead class="table-light">
                <tr><th>ID</th><th>Sigla</th><th>Descrição</th><th class="text-end">Ações</th></tr>
              </thead>
              <tbody>
              <?php foreach (($unidades ?? []) as $u): ?>
                <tr>
                  ...
                  <td class="text-end">
                    <a class="btn btn-sm btn-secondary" href="<?= \App\Core\Url::to('/admin/unidades/editar').'?id='.(int)$u->id ?>">
                      <i class="bi bi-pencil-square"></i> Editar
                    </a>
                    <form method="post" action="<?= \App\Core\Url::to('/admin/unidades/excluir') ?>" class="d-inline" onsubmit="return confirm('Excluir?')">
                      <?= \App\Core\Csrf::input() ?>
