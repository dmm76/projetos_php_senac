          ...
          <div class="row g-3 mb-4">
              ...
              <div class="card h-100 shadow-sm">
                <div class="card-body">
                  <div class="d-flex justify-content-between align-items-start">
                    <div><div class="text-muted small">Pedidos</div><div class="display-6"><?= $totalPedidos ?></div></div>
                    <i class="bi bi-bag" style="font-size:1.6rem"></i>
                  </div>
                </div>
                <div class="card-footer bg-transparent">
                  <a class="small text-decoration-none" href="<?= Url::to('/conta/pedidos') ?>">Ver todos os pedidos →</a>
                </div>
              </div>
            </div>
            ...
            <div class="col-12 col-md-4">
              <div class="card h-100 shadow-sm">
                <div class="card-body">
                  <div class="d-flex justify-content-between align-items-start">
                    <div><div class="text-muted small">Endereços</div><div class="display-6"><?= $qtdEnderecos ?></div></div>
                    <i class="bi bi-geo-alt" style="font-size:1.6rem"></i>
                  </div>
                </div>
                <div class="card-footer bg-transparent d-flex gap-3">
                  <a class="small text-decoration-none" href="<?= Url::to('/conta/enderecos') ?>">Gerenciar endereços</a>
                  <span class="text-muted">·</span>
                  <a class="small text-decoration-none" href="<?= Url::to('/conta/dados') ?>">Meus dados</a>
                </div>
              </div>
            </div>
            ...
            <div class="col-12 col-md-4">
              <div class="card h-100 shadow-sm">
                <div class="card-body">
                  <div class="d-flex justify-content-between align-items-start">
                    <div><div class="text-muted small">Itens no carrinho</div><div class="display-6"><?= $cartCount ?></div></div>
                    <i class="bi bi-cart" style="font-size:1.6rem"></i>
                  </div>
                </div>
                <div class="card-footer bg-transparent">
                  <a class="small text-decoration-none" href="<?= Url::to('/carrinho') ?>">Ir para o carrinho →</a>
                </div>
              </div>
            </div>
          </div>
              ...
              <?php if (!empty($ultimosPedidos)): ?>
                <div class="table-responsive">
                  <table class="table table-hover table-sm align-middle mb-0">
                    <thead class="table-light"><tr><th>#</th><th>Código</th><th>Data</th><th>Status</th><th class="text-end">Total</th><th></th></tr></thead>
                    <tbody>
                    <?php foreach ($ultimosPedidos as $p): ?>
                      <tr>
                        ...
                        <td class="text-end"><a href="<?= Url::to('/conta/pedidos/' . (int)$p['id']) ?>" class="btn btn-sm btn-outline-primary">Ver</a></td>
                      </tr>
                    <?php endforeach; ?>
                    </tbody>
                  </table>
