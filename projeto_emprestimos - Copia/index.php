      ...
      <div class="mb-4">
        <?php if ($isLogged): ?>
          <div class="alert alert-light border d-flex justify-content-between align-items-center">
            <div>
              Olá, <strong><?php echo htmlspecialchars($nomeUser); ?></strong>! Bem-vindo ao painel de
              empréstimos.
            </div>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?php echo htmlspecialchars(date('d/m/Y', strtotime($e['data_emprestimo']))); ?>
                      </td>
                      <td><?php echo !empty($e['data_devolucao']) ? htmlspecialchars(date('d/m/Y', strtotime($e['data_devolucao']))) : '—'; ?>
                      </td>
                      <td>
                        <span
                          class="badge <?php echo $aberto ? 'text-bg-warning' : 'text-bg-success'; ?>">
