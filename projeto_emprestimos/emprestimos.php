                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="date" class="form-control" id="data_emprestimo" name="data_emprestimo"
                                    value="<?php echo htmlspecialchars($data_emprestimo); ?>">
                            </div>

                            <div class="col-md-3">
                                <label for="data_devolucao" class="form-label">Data de Devolução</label>
                                <input type="date" class="form-control" id="data_devolucao" name="data_devolucao"
                                    value="<?php echo htmlspecialchars($data_devolucao); ?>">
                            </div>
                    ...
                    <table class="table table-bordered table-sm align-middle">
                        ...
                        <tbody>
                            <?php foreach ($emprestimos as $emp): ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <?php echo htmlspecialchars($emp['data_devolucao']); ?></td>
                                    <?php if ($nivel === 'admin'): ?>
                                        <td class="text-center">
                                            <a class="btn btn-warning"
                                                href="?idEmprestimo=<?php echo (int)$emp['id']; ?>">Editar</a>
                                            &nbsp;|&nbsp;
                            ...
                            <?php if (empty($emprestimos)): ?>
                                <tr>
                                    <td colspan="<?php echo ($nivel === 'admin') ? 6 : 5; ?>"
                                ...
                                <tr>
                                    ...
                                    <?php if ($nivel === 'admin'): ?>
                                        <td class="text-center">
                                            ...
                                            <a class="btn btn-warning"
                                                href="editar.reserva.php?idReserva=<?php echo (int)$r['id']; ?>">Editar</a>
                                            &nbsp;|&nbsp;
